...
3. **`apply`**: Deploys `vm-vault-01` (192.168.0.201) and `vm-vault-02` (192.168.0.202) on `colossus`, and `vm-vault-03` (192.168.0.203) + `vm-vault-transit` (192.168.0.200) on `guardian`.
